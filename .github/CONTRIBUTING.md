...
Firstly thank you for your interest in contributing to _pandas-quality-ctrl_!
...
Next get the latest checkout of the _pandas-quality-ctrl_ repository:

```sh
git clone git@github.com:lmmx/pandas-quality-ctrl.git
```

Change into the newly created directory and **after activating your virtual environment**
install an editable version of pandas-quality-ctrl along with its tests requirements:

```sh
cd pandas-quality-ctrl
pip install -e .[tests]
```
...
Thank you for considering contribution to _pandas-quality-ctrl_!
