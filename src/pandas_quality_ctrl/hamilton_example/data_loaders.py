...
We could put data quality checks here - but we leave them as an exercise for the reader.

Note:
    (1) instead of @config.when* we could instead move these functions into specific independent modules, and then in
